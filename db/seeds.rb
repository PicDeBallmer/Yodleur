  ...
  sujets = Sujet.create!(
    [
      {createur: utilisateurs[0], groupe: groupes[0], titre:'Améliorer le WiFi dans les salles de TP',
        ...
        votes_blancs: 1, votes_pour: 5, votes_contre: 2},
      ...
      {createur: utilisateurs[0], groupe: groupes[2], titre:'Planter des arbres sur les humas',
        ...
        votes_blancs: 2, votes_pour: 5, votes_contre: 10},
      {createur: utilisateurs[1], groupe: groupes[3], titre:'Organiser un concert de Barbiche',
        ...
        votes_blancs: 0, votes_pour: 1000, votes_contre: 0}])

  plus_de_sujets = Sujet.create!(
    [
      {createur: utilisateurs[0], groupe: groupes[1], titre:'Installer une tireuse à bière dans chaque salle',
        description: 'Installer une tireuse à bière dans chaque salle',
        votes_blancs: 0, votes_pour: 0, votes_contre: 0, parent: sujets[1]}])
